...
def update_categories():
    ...
    url = 'https://sportsbook.draftkings.com//sites/US-VA-SB/api/v5/eventgroups/84240?format=json'
    try:
    ...
    for category in categories.values():
        try:
            url = f'https://sportsbook.draftkings.com//sites/US-VA-SB/api/v5/eventgroups/84240/categories/{category["id"]}?format=json'
            res = requests.get(url).json()
        except:
            print('error getting url')
            continue
...
def generate_draftkings_mlb_formatted_events():
    formatted_events = {}
    id_to_name = {}
    sport = 'mlb'
    ...
    for category in categories.values():
        for subcategory in category['subcategories'].values():
            try:
                url = f'https://sportsbook-us-va.draftkings.com//sites/US-VA-SB/api/v5/eventgroups/84240/categories/{category["id"]}/subcategories/{subcategory["id"]}?format=json'
                res = requests.get(url).json()
            except:
                print('error getting url')
                continue
