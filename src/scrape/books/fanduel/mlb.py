...
MONEYLINE = 'Moneyline'
TOTAL = 'Alternate Total Runs'
SPREAD = 'Alternate Run Lines'

def generate_fanduel_mlb_formatted_events():
    id_to_name = {}
    formatted_events = {}
    sport = 'mlb'
    ...
    try:
        ...
        for id, competition in competitions.items():
            if competition.get('name') == 'MLB Games' or competition.get('name') == 'MLB - Matches':
